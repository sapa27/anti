V18 r255 — GitHub Pages generated from GAS canonical source
...
5) create CANONICAL_MIRROR_MANIFEST.json with r255 and SHA-256 hashes;
...
DEPLOY
- Deploy GAS from gas-backend/ as r255.
...
R254 LOGIN TRANSPORT / BOOT HOTFIX
...
- Deploy gas-backend r255 to the SAME GAS Web App deployment first, then publish the generated github-pages output.

- Login shell is mounted before Vue readiness and remains usable when Vue CDN loading is delayed or fails.
- The legacy host.childNodes.length blocker is forbidden by the quality gate.
