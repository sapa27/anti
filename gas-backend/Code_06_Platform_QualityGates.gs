 ...
 * Prior staged quality-gate implementations were consolidated into this current owner in r253.
 */
var APP_QUALITY_CONTRACT_CURRENT = Object.freeze({
    stamp: "current-quality-gate-2026-08-09-r253",
...
function _automatedRegressionStatus_(options) {
    ...
    return {
        ok: failed.length === 0,
        stamp: "automated-regression-current-r253",
