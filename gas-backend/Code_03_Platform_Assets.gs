...
function getAppAssetManifest_() {
    return {
        stamp: _assetManifestStamp_(), sourceOwner: "gas-backend", canonicalRoot: "gas-backend", generatedMirrorRoot: "dist/assets", generatedMirrorPolicy: "cloudflare-pages-build-output-read-only", syncTool: "tools/build_cloudflare_pages.py", releaseGate: "", securityGate: "", contractFinalCleanup: !0, runtimeSlimmingEnabled: !0, writeSchemaUnification: !0, bundles: {
            appCritical: {
                files: [
